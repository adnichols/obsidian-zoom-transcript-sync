...
Otherwise extract from issue key argument or use `general` if no ticket.

Use the following information to understand how to create your document:
    - create your file under `thoughts/handoffs/<TICKET>/YYYY-MM-DD_HH-MM-SS_<TICKET>_description.md`, where:
